...
wire R_we;
reg  R_re = 1'd0;
reg  [2:0] wheels_cntrl_storage = 3'd0;
...
reg  csrbank4_dig_00_re = 1'd0;
wire [7:0] csrbank4_dig_00_r;
reg  csrbank4_dig_00_we = 1'd0;
wire [7:0] csrbank4_dig_00_w;
reg  csrbank4_dig_10_re = 1'd0;
wire [7:0] csrbank4_dig_10_r;
reg  csrbank4_dig_10_we = 1'd0;
wire [7:0] csrbank4_dig_10_w;
reg  csrbank4_dig_20_re = 1'd0;
wire [7:0] csrbank4_dig_20_r;
reg  csrbank4_dig_20_we = 1'd0;
wire [7:0] csrbank4_dig_20_w;
reg  csrbank4_dig_30_re = 1'd0;
wire [7:0] csrbank4_dig_30_r;
reg  csrbank4_dig_30_we = 1'd0;
wire [7:0] csrbank4_dig_30_w;
reg  csrbank4_dig_40_re = 1'd0;
wire [7:0] csrbank4_dig_40_r;
reg  csrbank4_dig_40_we = 1'd0;
wire [7:0] csrbank4_dig_40_w;
reg  csrbank4_dig_50_re = 1'd0;
wire [7:0] csrbank4_dig_50_r;
reg  csrbank4_dig_50_we = 1'd0;
wire [7:0] csrbank4_dig_50_w;
reg  csrbank4_dig_60_re = 1'd0;
wire [7:0] csrbank4_dig_60_r;
reg  csrbank4_dig_60_we = 1'd0;
wire [7:0] csrbank4_dig_60_w;
reg  csrbank4_dig_70_re = 1'd0;
wire [7:0] csrbank4_dig_70_r;
reg  csrbank4_dig_70_we = 1'd0;
wire [7:0] csrbank4_dig_70_w;
wire csrbank4_sel;
wire [13:0] interface5_bank_bus_adr;
wire interface5_bank_bus_we;
wire [31:0] interface5_bank_bus_dat_w;
reg  [31:0] interface5_bank_bus_dat_r = 32'd0;
reg  csrbank5_w0_re = 1'd0;
wire [7:0] csrbank5_w0_r;
reg  csrbank5_w0_we = 1'd0;
wire [7:0] csrbank5_w0_w;
reg  csrbank5_r_re = 1'd0;
wire csrbank5_r_r;
reg  csrbank5_r_we = 1'd0;
wire csrbank5_r_w;
wire csrbank5_sel;
...
wire [2:0] csrbank14_state0_r;
reg  csrbank14_state0_we = 1'd0;
wire [2:0] csrbank14_state0_w;
wire csrbank14_sel;
...
assign scl_oe = 1'd1;
assign scl_o = _w_storage[0];
assign sda_oe = _w_storage[1];
assign sda_o = _w_storage[2];
assign _r_status = sda_i;
always @(*) begin
	basesoc_we <= 1'd0;
...
assign csrbank4_dig_00_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_00_re <= 1'd0;
	csrbank4_dig_00_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank4_dig_00_re <= interface4_bank_bus_we;
		csrbank4_dig_00_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_10_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_10_we <= 1'd0;
	csrbank4_dig_10_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank4_dig_10_re <= interface4_bank_bus_we;
		csrbank4_dig_10_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_20_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_20_we <= 1'd0;
	csrbank4_dig_20_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank4_dig_20_re <= interface4_bank_bus_we;
		csrbank4_dig_20_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_30_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_30_re <= 1'd0;
	csrbank4_dig_30_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank4_dig_30_re <= interface4_bank_bus_we;
		csrbank4_dig_30_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_40_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_40_we <= 1'd0;
	csrbank4_dig_40_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank4_dig_40_re <= interface4_bank_bus_we;
		csrbank4_dig_40_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_50_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_50_re <= 1'd0;
	csrbank4_dig_50_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 3'd5))) begin
		csrbank4_dig_50_re <= interface4_bank_bus_we;
		csrbank4_dig_50_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_60_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_60_re <= 1'd0;
	csrbank4_dig_60_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 3'd6))) begin
		csrbank4_dig_60_re <= interface4_bank_bus_we;
		csrbank4_dig_60_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_70_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_dig_70_we <= 1'd0;
	csrbank4_dig_70_re <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank4_dig_70_re <= interface4_bank_bus_we;
		csrbank4_dig_70_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_dig_00_w = dig_0_storage[7:0];
assign csrbank4_dig_10_w = dig_1_storage[7:0];
assign csrbank4_dig_20_w = dig_2_storage[7:0];
assign csrbank4_dig_30_w = dig_3_storage[7:0];
assign csrbank4_dig_40_w = dig_4_storage[7:0];
assign csrbank4_dig_50_w = dig_5_storage[7:0];
assign csrbank4_dig_60_w = dig_6_storage[7:0];
assign csrbank4_dig_70_w = dig_7_storage[7:0];
assign csrbank5_sel = (interface5_bank_bus_adr[13:9] == 3'd7);
assign csrbank5_w0_r = interface5_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank5_w0_re <= 1'd0;
	csrbank5_w0_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank5_w0_re <= interface5_bank_bus_we;
		csrbank5_w0_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_r_r = interface5_bank_bus_dat_w[0];
always @(*) begin
	csrbank5_r_re <= 1'd0;
	csrbank5_r_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank5_r_re <= interface5_bank_bus_we;
		csrbank5_r_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_w0_w = _w_storage[7:0];
assign csrbank5_r_w = _r_status;
assign _r_we = csrbank5_r_we;
...
assign csrbank14_state0_r = interface14_bank_bus_dat_w[2:0];
always @(*) begin
...
assign csrbank14_state0_w = wheels_cntrl_storage[2:0];
...
always @(posedge sys_clk) begin
	...
	if (csrbank4_sel) begin
		case (interface4_bank_bus_adr[8:0])
			1'd0: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_00_w;
			end
			1'd1: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_10_w;
			end
			2'd2: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_20_w;
			end
			2'd3: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_30_w;
			end
			3'd4: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_40_w;
			end
			3'd5: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_50_w;
			end
			3'd6: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_60_w;
			end
			3'd7: begin
				interface4_bank_bus_dat_r <= csrbank4_dig_70_w;
			end
		endcase
	end
	if (csrbank4_dig_00_re) begin
		dig_0_storage[7:0] <= csrbank4_dig_00_r;
	end
	dig_0_re <= csrbank4_dig_00_re;
	if (csrbank4_dig_10_re) begin
		dig_1_storage[7:0] <= csrbank4_dig_10_r;
	end
	dig_1_re <= csrbank4_dig_10_re;
	if (csrbank4_dig_20_re) begin
		dig_2_storage[7:0] <= csrbank4_dig_20_r;
	end
	dig_2_re <= csrbank4_dig_20_re;
	if (csrbank4_dig_30_re) begin
		dig_3_storage[7:0] <= csrbank4_dig_30_r;
	end
	dig_3_re <= csrbank4_dig_30_re;
	if (csrbank4_dig_40_re) begin
		dig_4_storage[7:0] <= csrbank4_dig_40_r;
	end
	dig_4_re <= csrbank4_dig_40_re;
	if (csrbank4_dig_50_re) begin
		dig_5_storage[7:0] <= csrbank4_dig_50_r;
	end
	dig_5_re <= csrbank4_dig_50_re;
	if (csrbank4_dig_60_re) begin
		dig_6_storage[7:0] <= csrbank4_dig_60_r;
	end
	dig_6_re <= csrbank4_dig_60_re;
	if (csrbank4_dig_70_re) begin
		dig_7_storage[7:0] <= csrbank4_dig_70_r;
	end
	dig_7_re <= csrbank4_dig_70_re;
	interface5_bank_bus_dat_r <= 1'd0;
	if (csrbank5_sel) begin
		case (interface5_bank_bus_adr[8:0])
			1'd0: begin
				interface5_bank_bus_dat_r <= csrbank5_w0_w;
			end
			1'd1: begin
				interface5_bank_bus_dat_r <= csrbank5_r_w;
			end
		endcase
	end
	if (csrbank5_w0_re) begin
		_w_storage[7:0] <= csrbank5_w0_r;
	end
	_w_re <= csrbank5_w0_re;
	_r_re <= csrbank5_r_re;
	...
	if (csrbank14_state0_re) begin
		wheels_cntrl_storage[2:0] <= csrbank14_state0_r;
	end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-12 00:18:22.
//------------------------------------------------------------------------------
